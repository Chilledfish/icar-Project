...
# dictionaries
# -------------------------------------------
icar_to_datagov_makes = {"אודי": "אאודי",
                 "אופל": "אופל",
                 "איווקו": "איווקו",
                 "אינפיניטי": "ניסאן",
                 "איסוזו": "איסוזו",
...
moo1 = list(car_translation.items())
moo2 = [x[0] for x in moo1]
moo3 = [x.split(',') for x in moo2]
moo4 = [x[1] for x in moo1]
moo5 = OrderedDict(car_translation)
moo6 = dict(zip(moo4, moo2))
moo7 = list(set(moo2))
moo8 = list(set(moo4))
